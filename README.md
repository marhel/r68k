...
## Status
The current status of r68k is incomplete - about 1/2 of the opcodes, and some infrastrucure such as interrupts are yet to be implemented, and it's therefore _completely unusable_ at this point, unless you have very well behaved programs that consists solely of the implemented instructions. Sorry! 
