...
fn generate<'a>() -> Vec<OpcodeInfo<'a>> {
    vec![
        ...
        instruction!(MASK_OUT_X_EA, OP_EOR | BYTE_SIZED | DEST_EA, Size::Byte, "EOR", ea_memory_alterable, decode_dx_ea, is_dn_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_EOR | BYTE_SIZED | DEST_DX, Size::Byte, "EOR", ea_data_alterable, decode_ea_dx, is_ea_dn, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_EOR | WORD_SIZED | DEST_EA, Size::Word, "EOR", ea_memory_alterable, decode_dx_ea, is_dn_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_EOR | WORD_SIZED | DEST_DX, Size::Word, "EOR", ea_data_alterable, decode_ea_dx, is_ea_dn, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_EOR | LONG_SIZED | DEST_EA, Size::Long, "EOR", ea_memory_alterable, decode_dx_ea, is_dn_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_EOR | LONG_SIZED | DEST_DX, Size::Long, "EOR", ea_data_alterable, decode_ea_dx, is_ea_dn, encode_ea_dx),
        ...
        instruction!(MASK_OUT_EA, OP_CMPI | BYTE_SIZED, Size::Byte, "CMPI", ea_data, decode_imm_ea, is_imm_ea, encode_imm_ea),
        instruction!(MASK_OUT_EA, OP_CMPI | WORD_SIZED, Size::Word, "CMPI", ea_data, decode_imm_ea, is_imm_ea, encode_imm_ea),
        instruction!(MASK_OUT_EA, OP_CMPI | LONG_SIZED, Size::Long, "CMPI", ea_data, decode_imm_ea, is_imm_ea, encode_imm_ea),
