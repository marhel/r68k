...
fn generate<'a>() -> Vec<OpcodeInfo<'a>> {
    vec![
        ...
        instruction!(MASK_OUT_X_EA, OP_AND | BYTE_SIZED | DEST_EA, Size::Byte, "AND", ea_memory_alterable, decode_dx_ea, is_dx_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_AND | BYTE_SIZED | DEST_DX, Size::Byte, "AND", ea_data, decode_ea_dx, is_ea_dx, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_AND | WORD_SIZED | DEST_EA, Size::Word, "AND", ea_memory_alterable, decode_dx_ea, is_dx_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_AND | WORD_SIZED | DEST_DX, Size::Word, "AND", ea_data, decode_ea_dx, is_ea_dx, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_AND | LONG_SIZED | DEST_EA, Size::Long, "AND", ea_memory_alterable, decode_dx_ea, is_dx_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_AND | LONG_SIZED | DEST_DX, Size::Long, "AND", ea_data, decode_ea_dx, is_ea_dx, encode_ea_dx),
