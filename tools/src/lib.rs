...
fn generate<'a>() -> Vec<OpcodeInfo<'a>> {
    vec![
        ...
        instruction!(MASK_OUT_X_EA, OP_EOR | BYTE_SIZED | DEST_DX, Size::Byte, "EOR", ea_data, decode_ea_dx, is_ea_dn, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_EOR | WORD_SIZED | DEST_EA, Size::Word, "EOR", ea_memory_alterable, decode_dx_ea, is_dn_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_EOR | WORD_SIZED | DEST_DX, Size::Word, "EOR", ea_data, decode_ea_dx, is_ea_dn, encode_ea_dx),
        instruction!(MASK_OUT_X_EA, OP_EOR | LONG_SIZED | DEST_EA, Size::Long, "EOR", ea_memory_alterable, decode_dx_ea, is_dn_ea, encode_dx_ea),
        instruction!(MASK_OUT_X_EA, OP_EOR | LONG_SIZED | DEST_DX, Size::Long, "EOR", ea_data, decode_ea_dx, is_ea_dn, encode_ea_dx),
